...
int main(int argc, char** argv)
{
    ...
    if (f)
    {
        ...
        free(line);
        printf(
            "Please consult the [README](https://github.com/shadesofdeath/ExplorerPatcher-/blob/master/README.md) for more details.\n"
            "A detailed change log is available [here](https://github.com/shadesofdeath/ExplorerPatcher-/blob/master/CHANGELOG.md).\n"
            ...
            "*This release has been published automatically from %s %s in %s [%s](https://github.com/shadesofdeath/ExplorerPatcher-/tree/%s/).*",
            argc == 5 ? argv[4] : "https://github.com/shadesofdeath/ExplorerPatcher-/actions",
